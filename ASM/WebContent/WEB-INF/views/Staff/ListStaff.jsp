	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="header-area">
					...
					<div class="row align-items-center">
						<div class="col-sm-6">
							<div class="breadcrumbs-area clearfix">
								<h4 class="page-title pull-left">Danh Sách Nhân Viên</h4>
				...
				<table class="table table-hover" width="100%" border="1" style="text-align: center; font-size:11px">
					...
					<tr>
						<c:forEach var="s" items="${staffs}">
							...
							<tr>
								...
								<td>${s.birthday}</td>
								<td><img src="files/${s.photo}" Width="50px" height="50px"/></td>
								<td>${s.email}</td>
								<td>${s.phone}</td>
								<td>${s.salary}</td>
								<td>${s.notes}</td>
								<td>${s.departid.name}</td>
								<td><a href="Staff/${s.id}.htm" class="button">CẬP NHẬT</a></td>
								<td><a href="Staff/${s.id}Xoa.htm" class="button1">XÓA</a></td>
