				...
				<div class="page-title-area">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<form:input path="id" type="id" class="form-control" laceholder="ID"  />
						</div>
						...
						<div class="form-group">
							<label>Hình Ảnh:</label>
								<img src="files/${staff.photo}"Width="150px" height="150px"/>
							<form:input path="photo"  type="file" name="photo" class="form-control"
								placeholder="Photo" />
