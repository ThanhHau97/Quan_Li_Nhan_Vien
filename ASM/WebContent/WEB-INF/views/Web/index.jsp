	...
	<div class="page-container">
					...
					<nav>
						<ul class="metismenu" id="menu">
							...
							<li><a href="javascript:void(0)" aria-expanded="true"><i
									class="fa fa-users"></i> <span>Quản Lí Nhân Viên</span></a>
								<ul class="collapse">
							...
							<li><a href="javascript:void(0)" aria-expanded="true"><i
									class="fa fa-address-book"></i> <span>Quản Lí Phòng Ban</span></a>
								<ul class="collapse">
									<li><a href="Departs/AddDeparts.htm">Thêm Phòng Ban</a></li>
									<li><a href="Departs/ListDeparts.htm">Danh Sách Phòng
											Ban</a></li>
								</ul></li>
							<li><a href="javascript:void(0)" aria-expanded="true"><i
									class="fa fa-institution"></i> <span>Quản Lí Thành Tích</span></a>
								<ul class="collapse">
									<li><a href="Record/AddRecord.htm">Thêm Thành Tích &
											Kỉ Luật</a></li>
									<li><a href="Record/ListRecord.htm">Danh Sách Thành
											Tích & Kỉ Luật</a></li>
		...
		<div class="main-content">
			...
			<table class="table table-hover" width="100%" border="1"
				...
				<tr>
			<h1 style="text-align: center; font-size:30px; color:blue;" ->Top 10 Nhân Viên Có Thành Tích Tốt</h1>
					<c:forEach begin="0" end="10" var="a" items="${index}">
						
						<div class="gallery">
							<a target="_blank" href="img_5terre.jpg"> 
							<img src="files/${a[2]}" alt="Cinque Terre"/>
							</a>
							<div class="desc">${a[1]}</div>
								<div class="desc"><a style="color:red">${a[3]}</a></div>
						</div>
