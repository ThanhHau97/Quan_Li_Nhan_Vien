            ...
            <div class="header-area">
                ...
                <div class="page-title-area">
                    ...
                    <br>
                     ...
                     <form:form action="Departs/Update.htm" modelAttribute="phongban">
                 ${message}
                    <label>Mã Phòng Ban:</label> <form:input path="id" class="form-control" type="text" name="id"/><br>
                    <label>Tên Phòng Ban:</label> <form:input path="name" class="form-control" type="text" name="name"/><br>
