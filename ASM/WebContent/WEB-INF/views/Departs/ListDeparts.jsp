                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Danh Sách Phòng Ban</h4>
                                <ul class="breadcrumbs pull-left">
                                    <li><a href="Web/index.htm">Trang Chủ</a></li>
                                    <li><span>Danh Sách Phòng Ban</span></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <tr>
                     <c:forEach var="d" items="${Departs}">
							<tr>
								...
								<td>${d.id}</td>
								<td>${d.name}</td>
								<td><a href="Departs/${d.id}.htm" class="button">CẬP NHẬT</a></td>
								<td><a href="Departs/${d.id}Xoa.htm" class="button1">XÓA</a></td>
