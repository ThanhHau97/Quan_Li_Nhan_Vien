    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="header-area">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Thêm Phòng Ban</h4>
                                <ul class="breadcrumbs pull-left">
                                    <li><a href="Web/index.htm">Trang Chủ</a></li>
                                    <li><span>Thêm Phòng Ban</span></li>
                                </ul>
                            </div>
                        </div>
              ...
              <form:form action="Departs/AddDeparts.htm" modelAttribute="phongban">
                 ${message}
                    <label>Mã Phòng Ban:</label> 
                    <form:input path="id" class="form-control" type="text" name="id"/><br>
                     <form:errors path="id"/><br>
                    <label>Tên Phòng Ban:</label> 
                    <form:input path="name" class="form-control" type="text" name="name"/><br>
