        ...
        <div class="main-content">
            ...
            <div class="header-area">
                ...
                <div class="page-title-area">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Thêm Thành Tích & Kỉ Luật</h4>
                                <ul class="breadcrumbs pull-left">
                                    <li><a href="Web/index.htm">Trang Chủ</a></li>
                                    <li><span>Thêm Thành Tích & Kỉ Luật</span></li>
                                </ul>
                            </div>
                        </div>
                   ...
                   ${message}
               <form:form action="Record/AddRecord.htm" modelAttribute="record">
                    <label>Mã Nhân Viên:</label> 
                    <form:select path="staffid.id" class="form-control"  items="${staffs}" itemValue="id" itemLabel="id" />
                    <label>Loại: </label>&nbsp;&nbsp;
                    	<form:radiobutton path="type" value="false" label="Thành tích" />&nbsp;&nbsp;&nbsp;&nbsp;
			            <form:radiobutton path="type" value="true" label="Kỷ luật" /><br>
                    <label>Lí Do:</label> 
                    	<form:textarea path="reason" class="form-control" /><br>
