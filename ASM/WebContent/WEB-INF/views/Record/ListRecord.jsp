					...
					<div class="row align-items-center">
						<div class="col-sm-6">
							<div class="breadcrumbs-area clearfix">
								<h4 class="page-title pull-left">Danh Sách Thành Tích & Kỉ
									Luật</h4>
								<ul class="breadcrumbs pull-left">
									<li><a href="Web/index.htm">Trang Chủ</a></li>
									<li><span>Danh Sách Thành Tích & Kỉ Luật</span></li>
								</ul>
							</div>
						</div>
					...
					<tr>
						<c:forEach var="r" items="${records}">
							<tr>
								...
								<td>${r.id}</td>
								<td>${r.type?'Kỉ Luật':'Thành Tích'}</td>
								<td>${r.reason}</td>
								<td>${r.date}</td>
								<td>${r.staffid.id}</td>
								<td><a href="Record/${r.id}.htm" class="button">CẬP NHẬT</a></td>
								<td><a href="Record/${r.id}Xoa.htm" class="button1">XÓA</a></td>
